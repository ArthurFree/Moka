import type { CustomHTMLRenderer } from '@editorType/editor';
import type { OpenTagToken } from '@editorType/toastmark';
import { MergedTableCellMdNode, MergedTableRowMdNode } from '@pluginTableMergedCell/index';
