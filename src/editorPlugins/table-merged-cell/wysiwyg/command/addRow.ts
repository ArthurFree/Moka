import type { PluginContext } from '@editorType/editor';
import type { TableOffsetMapFactory, TableOffsetMap, CommandFn, SelectionInfo } from '@pluginTableMergedCell/index';
