 ...
 * $$
 */
import type { PluginInfo, MdNode, PluginContext } from '@editorType/index';
import Chart, {
    BaseOptions,
    LineChart,
    AreaChart,
...
import { PluginOptions } from '@pluginChartType/index';
import csv from './csv';
            ...
            if (matched) {
                ...
                if (value) {
                    ...
                    keys.forEach((key, index) => {
                        refOptions[key] =
                            refOptions[key] || (keys.length - 1 === index ? value : {});
