...
export class CustomBlockView implements NodeView {
            ...
            state: EditorState.create({
                ...
                plugins: [
                    keymap({
                        ...
                        'Shift-Mod-z': () =>
                            redo(this.innerEditorView!.state, this.innerEditorView!.dispatch),
                        Tab: (state, dispatch) => {
    ...
    private saveAndFinishEditing() {
        ...
        this.editorView.dispatch(
            outerState.tr.setSelection(createTextSelection(outerState.tr, to))
        );
    ...
    private cancelEditing() {
        ...
        this.editorView.dispatch(
            outerState.tr.setSelection(TextSelection.create(outerState.doc, to))
        );
        this.editorView.focus();
